module.exports = {
  ...
  fn: async function (inputs) {
    ...
    async.concat(reviews, function (iInfo, callbackv) {
...
//             :["Orgulloso de Santiago y sus activades"]}],"images":[{"image":["/199393.JPG"]}],"videos":["/fgdd.mp4"],"records":["/gardd.mp3"]}
     ...
     // console.log(JSON.stringify(iInfo))
      ...
      ProcessInputReviewService.insertDataInSystem(objectToUpdate, citizenInfo, source, source, function (err, reviewInsert) {
        if (err) {
