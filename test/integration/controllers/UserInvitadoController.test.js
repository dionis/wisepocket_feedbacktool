        ...
        it('should redirect to /my/page', function (done) {
            ...
            UserInvitado.find().then(zookeepers => {
                ...
                Campaign.find().then(zookeepers => {
                    ...
                    console.log("---- New Test execution data ----", zookeepers[0].nombre)
                    console.log("FIND Campaign BY NAME ", camp.nombre);
                    supertest(sails.hooks.http.app)
                        .post('/userInvitado/addCampaigns').query({ nombre: camp.nombre, id: userInv.id })
                        .expect(200)
                        .then(response => {
    ...
    describe('#getCampXInvitado', function () {
        it('should redirect to /my/page', function (done) {
            UserInvitado.find().then(zookeepers => {
                ...
                supertest(sails.hooks.http.app)
                    .get('/userInvitado/getCampXInvitado').query({ id: userInv.id })
                    .expect(200)
                    .then(response => {
                        console.log("Service OK:" + response.text)
    ...
    describe('#getInvXUserChief', function () {
        it('should redirect to /my/page', function (done) {
            User.find().then(zookeepers => {
                ...
                supertest(sails.hooks.http.app)
                    .get('/userInvitado/getInvXUserChief').query({ id: user.id })
                    .expect(200)
                    .then(response => {
                        console.log("Service OK:" + response.text)
    ...
    describe('#updateAcces', function () {
        it('should redirect to /my/page', function (done) {
            UserInvitado.find().then(zookeepers => {
                ...
                console.log("FIND Invitado BY NAME ", userInv.nombre);
                supertest(sails.hooks.http.app)
                    .patch('/userInvitado/updateAcces').query({ acceso: true, id: userInv.id })
                    .expect(200)
                    .then(response => {
                        console.log("Service OK:" + response.text)
    ...
    describe('#getInvitadoXCamp', function () {
        it('should redirect to /my/page', function (done) {
            Campaign.find().then(zookeepers => {
                ...
                console.log("FIND Campaign BY NAME ", camp.nombre);
                supertest(sails.hooks.http.app)
                    .get('/campaign/getInvitadoXCamp').query({ id: camp.id })
                    .expect(200)
                    .then(response => {
                        console.log("Service OK:" + response.text)
