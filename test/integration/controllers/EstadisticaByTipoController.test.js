...
describe('EstadisticaByTipoController.getCPostivaXDia', () => {
  before(() => {
  ...
  describe('total de opiniones positivas por dia de una Campaña', () => {
...
describe('EstadisticaByTipoController.getCNegativaXDia', () => {
  before(() => {
    // runs once before the first test in this block
    //https://mochajs.org/#hooks
  });
  ...
  describe('total de opiniones negativas por dia de una Campaña', () => {
    it('should redirect to /my/page', (done) => {
      Campaign.find().then(zookeepers => {
        let campaign = zookeepers[0];
        console.log('---- New Test execution data ----', zookeepers[0].id);
...
describe('EstadisticaByTipoController.getCNeutraXDia', () => {
  before(() => {
    // runs once before the first test in this block
    //https://mochajs.org/#hooks
  });
  ...
  describe('total de opiniones neutras por dia de una Campaña', () => {
    it('should redirect to /my/page', (done) => {
      Campaign.find().then(zookeepers => {
        let campaign = zookeepers[0];
        console.log('---- New Test execution data ----', zookeepers[0].id);
...
describe('EstadisticaByTipoController.getCantTotalXDia', () => {
  before(() => {
    // runs once before the first test in this block
    //https://mochajs.org/#hooks
  });
  ...
  describe('total de opiniones por dia de una Campaña', () => {
    it('should redirect to /my/page', (done) => {
      Campaign.find().then(zookeepers => {
        let campaign = zookeepers[0];
        console.log('---- New Test execution data ----', zookeepers[0].id);
