  ...
  fn: async function (inputs, exits) {
    ...
    if (typeof review.campaing === "undefined") {
      ...
      newReview = await Review.find({
          ...
          result = await sails.helpers.insertImages( newReview, source).tolerate('noImageFound',()=>{
              ///Not image found to insert
          })
           if (newReview !== undefined)
            return exits.success(newReview[0]);
           else
             throw exits.errorNotInsert() 
    }    
  }
};
