...
//         fs.readFile( appRoot + path.sep + pathToFile + '\\WifiExampleMessage.xml', function(err, data) {
...
//       var parser = new xml2js.Parser({trim: true});
//       //console.log("Direccion " + __dirname);
//       fs.readFile(appRoot + path.sep + pathToFile + + '/BadWifiExampleMessage.xml', function (err, data) {
//         parser.parseString(data, function (err, result) {
//           // console.log(util.inspect(result, false, null))
//           //console.log("Tamano de information "+ JSON.stringify(result.update.informations))
//           //console.log("Tamano de informationes "+ JSON.stringify(result.update.informations[0].info.length))
...
//       fs.readFile(appRoot + path.sep + pathToFile + '/BadWifiExampleMessage.xml', "utf-8", function (err, data) {
        
//         sails.helpers.validateWifiReview(data)
...
//       fs.readFile(appRoot + path.sep + pathToFile + '/NoContactWifiExampleMessage.xml', "utf-8", function (err, data) {
//          sails.helpers.validateWifiReview(data)
//           .then(function(result){                     
//            }).catch(function (err){            
...
//       fs.readFile(appRoot + path.sep + pathToFile + '/NoTextWifiExampleMessage.xml', "utf-8", function (err, data) {
//         sails.helpers.validateWifiReview(data)
//         .then(function(result){                     
//          }).catch(function (err){            
//            assert.equal("NotExistInfo", err.code); 
...
//     it('XML invalid no Text information', function (done) {
//       fs.readFile(appRoot + path.sep + pathToFile + '/NotInfoWifiExampleMessage.xml', "utf-8", function (err, data) {
//          sails.helpers.validateWifiReview(data).then(function(result){                     
//         }).catch(function (err){            
//           assert.equal("NotExistInfo", err.code); 
//           done()
//         })
