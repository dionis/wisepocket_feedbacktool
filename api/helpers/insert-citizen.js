module.exports = {
  ...
  inputs: {
    ...
    sourceCitizen: {
      type: 'ref',
      example:
        '{ name:Pepe, address:Calle 5ta y Ave Lutero #4533, phone:2344334433   }',
  ...
  fn: async function (inputs, exits) {
    ...
    if (
      typeof sourceCitizen !== 'undefined' &&
      typeof sourceReview !== 'undefined' &&
      typeof sourceInSystem !== 'undefined'
    ) {
      ...
      Citizen.findOne({
        ...
        if (err) {
          ...
          if (typeof resultCitizen === 'undefined') {
            ...
            let citizendInfoEx = await Citizen.find({
              name: sourceCitizen.name,
              lastname: sourceCitizen.lastname,
              address: sourceCitizen.address,
              phonenumber: sourceCitizen.phone,
            ...
            let insertReview = await sails.helpers.insertReview.with({
              review: sourceReview,
            ...
            let result = await sails.helpers.updateCitizenSource
              .with({
            ...
            let result = await sails.helpers.updateCitizenSource.with({
